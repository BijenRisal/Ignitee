...
<!--            <div class="search-container">
            ...
            <contents>
                ...
                <a href="UserController?page=scholar">
                    <div class="box">
                        <div class="img-box">
                            <img src="nami.jpg" alt="" width="100%" height="100%">
                        </div>
                        <p><b>Cambridge GCE A Levels, University of Northampton, UK</b></p>

                        <p>Jorpati, Gokarneshwar, Kathmandu</p>
                    </div>
                </a>
                <div class="box">
                    <div class="img-box">
                        <img src="Quest.jpg" alt="" width="100%" height="100%">
                    </div>
                    <p><b> Quest International College, Pokhara University</b></p>
                ...
                <div class="box">
                    <div class="img-box">
                        <img src="campion.jpg" alt="" width="100%" height="100%">
                    </div>
                    <p><b>Campion College, Tribhuvan University</b></p><br>

                    <p>Sanepa, Lalitpur</p>
                </div>
                <div class="box">
                    <div class="img-box">
                        <img src="kathmandu model.jpg" alt="" width="100%" height="100%">
                    </div>
                    <p><b>Kathmandu Model College, Tribhuvan University</b></p>

                    <p>Bagbazar, Kathmandu</p>
                </div>
                <div class="box">
                    <div class="img-box">
                        <img src="swastik.jpg" alt="" width="100%" height="100%">
                    </div>
                    <p><b>Swastik College,Tribhuvan University</b></p>
                    <br>
                    <p>Madhyapur Thimi, Bhaktapur</p>
                </div>
                <div class="box">
                    <div class="img-box">
                        <img src="united.jpg" alt="" width="100%" height="100%">
                    </div>
                    <p> <b>United College, Tribhuvan University</b></p>
                    <br>
        ...
        <div class="pagination">
            <ul>
                ...
                <li><a href="UserController?page=page-1">1</a></li>
                <li><a href="#">2</a></li>
                <li><a href="#">3</a></li>
