    ...
    <head>
        ...
        <style>
            *{
            ...
            .change-password-form form input[type=password] {
                width: 100%;
                padding: 12px 20px;
                margin: 8px 0;
                border: 1px solid #ccc;
            ...
            .change-password-form form button[type=submit] {
            ...
            .change-password-form form button[type=submit]:hover {
    ...
    <body>
        ...
        <div class="banner">
            <div class="change-password-form">
                ...
                <form action="UserController?page=updatePassword" method="post">
